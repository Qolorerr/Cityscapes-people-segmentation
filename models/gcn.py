...
class GCN(BaseModel):
    def __init__(
        ...
        **_
        ...
        if self.use_deconv:
            self.decon1 = nn.ConvTranspose2d(
                num_classes,
                num_classes,
                kernel_size=3,
                padding=1,
            ...
            self.decon2 = nn.ConvTranspose2d(
                num_classes,
                num_classes,
                kernel_size=3,
                padding=1,
            ...
            self.decon3 = nn.ConvTranspose2d(
                num_classes,
                num_classes,
                kernel_size=3,
                padding=1,
            ...
            self.decon4 = nn.ConvTranspose2d(
                num_classes,
                num_classes,
                kernel_size=3,
                padding=1,
            ...
            self.decon5 = nn.ConvTranspose2d(
                num_classes,
                num_classes,
                kernel_size=3,
                padding=1,
    ...
    def forward(self, x):
        ...
        if self.use_deconv:
            ...
            x1 = F.interpolate(
                self.br7(x1 + x2), size=conv1_sz, mode="bilinear", align_corners=True
            )

            x = self.br9(
                F.interpolate(self.br8(x1), size=x.size()[2:], mode="bilinear", align_corners=True)
            )
