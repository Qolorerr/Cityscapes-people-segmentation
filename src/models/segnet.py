...
from src.utils.helpers import set_trainable
    ...
    def __init__(
        ...
        **_
        ...
        self.stage5_decoder = nn.Sequential(
            *decoder[33:], nn.Conv2d(64, num_classes, kernel_size=3, stride=1, padding=1)
        )
...
class LastBottleneck(nn.Module):
    def __init__(self, inchannels):
        ...
        self.conv2 = nn.Conv2d(
            inchannels // 4, inchannels // 4, kernel_size=3, padding=1, bias=False
        )
        self.bn2 = nn.BatchNorm2d(inchannels // 4)
